...
public class StaticShader extends ShaderProgram {
	...
	private static final String	VERTEX_SHADER_FILE		= "src/shader/vertexShader";
	private static final String	FRAGMENT_SHADER_FILE	= "src/shader/fragmentShader";
	...
	protected void getAllUniformLocations() {
		...
		for (int i = 0; i < MAX_LIGHTS; i++) {
			location_lightPosition[i] = super.getUniformLocation(
					"lightPosition[" + i + "]");
			location_lightColor[i] = super.getUniformLocation(
					"lightColor[" + i + "]");
			location_attenuation[i] = super.getUniformLocation(
					"attenuation[" + i + "]");
		}
	}

	public void loadNumberOfRows(int number) {
		super.loadFloat(location_numberOfRows, (float) number);
	}
	...
	public void loadFog(Fog fog) {
		super.loadVector(location_skyColor, fog.getColor());
